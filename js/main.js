...
const projectData = [
  {
    title: "AR EdutainmentUPS",
    subTitle:
      "You can easily learn with augmented reality.",
    thumbnail: "./img/logoproyect1.png",
    description:
      "Generated for learning about identity cultures, entertained and interacting with their mobile device, through applied technologies such as Vuforia AR, Unity, Google Play.",
    techStack: ["Unity, VuforiaAR, C#, Postman"],
    srcURL: "./proyects/Proyect1/index.html",
  },
  {
    title: "Sifac accounting module for financial system with Odoo",
    subTitle: "Accounting module in Odoo, developed to manage employee payments according to their position and attendance.",
    thumbnail: "./img/thumbnails/sicaf-thumbnail.png",
    description:
      "Sifac, It manages an accounting system that tracks employees’ attendance, departmental roles, and salaries according to their positions, aplicando lenguajes de programacion como Odoo, Python",
    techStack: ["Python", "Odoo14", "Docker","Postgresql"],
    srcURL: "./proyects/Proyect2/index.html",
  },
  {
    title: "ConsorcioGis",
    subTitle:
      "Generate software for the automation and correction of drawings in ARGIS files, with Python's Geopandas.",
    thumbnail: "./img/logoproyect3.png",
    description:
      "Software developed in Python implementing the Geopandas library, to generate code for the automation and correction of drawings for visualization in ARGIS, such as geographic components like poles, high and low voltage routes, electronic components of the electrical network system.",
    techStack: ["Python", "ARCGIS", "Geopandas"],
    srcURL: "./proyects/Proyect3/index.html",
  },
    ...
    elem.innerHTML = buildTemplate(
      `  
       <div class='projects-header'>
          <img class="card-img-top img-fluid" style="display: flex; justify-content: center height: 200px; object-fit: cover;"  src={thumbnail} alt="Card image cap" width="500" height="600" >
       </div>
       <h5 class="card-title mt-3">{title}</h5>
       <div class='content'>{description}</div>
       <div class='technologies'>Tech Stack: ${techStackData}</div>
       <div class="card-buttons">
          <a href="https://github.com/Vinicio-veletanga25" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
