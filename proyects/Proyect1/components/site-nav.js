...
class SiteNav extends HTMLElement {
  ...
  _render() {
    ...
    const left = back
      ...
      : `<a href="./../../index.html" class="text-sm font-bold text-foreground tracking-tight">My Portfolio</a>`;
    ...
    const right = back
      ...
      : `<nav class="hidden gap-6 sm:flex" aria-label="Navegación principal">  
           ...
           <a  class="text-sm font-semibold text-primary hover:text-primary/80" onclick="toProblem()" >Problematic</a>
           <a   class="text-sm font-semibold text-primary hover:text-primary/80" onclick="toSolution()" >Solution</a>
           <a   class="text-sm font-semibold text-primary hover:text-primary/80" onclick="toResult()" >Result</a>
         </nav>
...
function toProblem() {
  var element = document.getElementById("sectionProble");
  var headerOffset = 85;
...
function toSolution() {
  var element = document.getElementById("sectionSolution");
  var headerOffset = 85;
  var elementPosition = element.getBoundingClientRect().top;
  var offsetPosition = elementPosition + window.pageYOffset - headerOffset;
...
function toResult() {
  var element = document.getElementById("sectionResult");
  var headerOffset = 85;
  var elementPosition = element.getBoundingClientRect().top;
  var offsetPosition = elementPosition + window.pageYOffset - headerOffset;
